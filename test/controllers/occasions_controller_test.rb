...
class OccasionsControllerTest < ActionController::TestCase
  ...
  test "should create occasion" do
    assert_difference('Occasion.count') do
      post :create, occasion: { description: @occasion.description, heroclass: @occasion.heroclass, icon: @occasion.icon, image: @occasion.image, name: @occasion.name, published: @occasion.published }
    end
  ...
  test "should update occasion" do
    patch :update, id: @occasion, occasion: { description: @occasion.description, heroclass: @occasion.heroclass, icon: @occasion.icon, image: @occasion.image, name: @occasion.name, published: @occasion.published }
    assert_redirected_to occasion_path(assigns(:occasion))
  end
