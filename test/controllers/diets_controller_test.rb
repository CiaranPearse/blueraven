...
class DietsControllerTest < ActionController::TestCase
  ...
  test "should create diet" do
    assert_difference('Diet.count') do
      post :create, diet: { description: @diet.description, heroclass: @diet.heroclass, icon: @diet.icon, image: @diet.image, name: @diet.name, published: @diet.published }
    end
  ...
  test "should update diet" do
    patch :update, id: @diet, diet: { description: @diet.description, heroclass: @diet.heroclass, icon: @diet.icon, image: @diet.image, name: @diet.name, published: @diet.published }
    assert_redirected_to diet_path(assigns(:diet))
  end
